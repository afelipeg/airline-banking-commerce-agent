...
// --- Listings: flights (cabins as variants), ancillaries, the card, insurance, miles, Quasar Pay ---
...
export interface PricingContext {
  ...
  // Portfolio fields (card tiers, insurance plans); absent on flights and ancillaries.
...
export interface TodaySnapshot {
  ...
  card_approvals: number;
  /** Not in the overview today; the tile asks the assistant when it is absent. */
  fintech_revenue?: number | null;
}
...
// --- Fintech portfolio (GET /base): card accounts and insurance policies ---
...
/** Telecom plan-mix keys, fintech meaning: subscribers = active accounts or policies,
 * churn_rate_pct = monthly cancellation, arpu = monthly revenue per account,
 * wholesale_cost_per_line_usd / margin_per_line_usd = monthly cost / margin per account. */
...
/** The portfolio's economics footnote. */
...
// --- Portfolio mix extension (present_portfolio_mix, component plan_mix) ---
