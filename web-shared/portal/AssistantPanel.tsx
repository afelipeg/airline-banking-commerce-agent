...
const ACTION_CHIP = /\b(approve|apply|dismiss|discard|aprueb\w*|aprobar|aplica\w*|descarta\w*)\b/i;
    ...
    <div className="flex h-full w-full flex-col border-l border-(--line) bg-(--card)">
      <div className="flex items-center gap-2.5 border-b border-(--line) py-3 pl-4 pr-2.5">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="truncate text-[11.5px] text-(--ink-soft)">Tú apruebas cada cambio</div>
        </div>
        ...
        <IconButton icon="x" label="Ocultar asistente" onClick={onClose} />
      </div>
