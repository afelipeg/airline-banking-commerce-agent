    ...
    <FrameContext.Provider value={frame}>
      <div className="flex h-dvh flex-col text-(--ink)">
        <header className="flex h-[58px] shrink-0 items-center gap-2 border-b border-(--line) bg-(--chrome) px-3 sm:gap-5 sm:px-5">
          ...
          <nav className="flex min-w-0 items-center gap-1" aria-label="Vistas">
            {views.map((item) => {
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              aria-label={`Abrir ${bag.label.toLowerCase()}, ${bag.count} ${bag.noun}${bag.count === 1 ? "" : "s"}`}
            ...
            <button
              ...
              aria-label={`${shopper.name}: perfil y memoria`}
        ...
        {activityOpen ? (
          <Inspector
            ...
            memoryTitle={`Lo que ${assistantName} sabe de ti`}
